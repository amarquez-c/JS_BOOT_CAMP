...
function getClientElement(client) {
  var allAccounts = DataBusiness.getAccounts(); // Debemos importarla de ...
  ...
  var ul = AccountBusiness.getClientAccountsElement(clientAccounts); // Debemos importarla ...
...
},{"./data-business.js":"src/data-business.js","./account-business.js":"src/account-business.js"}],"src/client-list-business.js":[function(require,module,exports) {
"use strict";
...
function printClientsAccounts() {
  var clients = DataBusiness.getClient(); // Importa de data-business.js
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var element = ClientBusiness.getClientElement(client); // Importa de client-business.js
...
},{"./data-business.js":"src/data-business.js","./client-business.js":"src/client-business.js"}],"index.js":[function(require,module,exports) {
"use strict";

var ClientListBusiness = _interopRequireWildcard(require("./src/client-list-business.js"));

function _getRequireWildcardCache() { if (typeof WeakMap !== "function") return null; var cache = new WeakMap(); _getRequireWildcardCache = function () { return cache; }; return cache; }

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } if (obj === null || typeof obj !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }

// En esta parte vamos a colocar los import
window.onload = function () {
  ClientListBusiness.printClientsAccounts();
}; // Importa de client-list-business;
},{"./src/client-list-business.js":"src/client-list-business.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/Playground_08.e31bb0bc.js.map